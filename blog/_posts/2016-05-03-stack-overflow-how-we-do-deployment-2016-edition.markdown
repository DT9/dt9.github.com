...
What do the tiers really translate to? All of our development sites are on WEB10 and WEB11 servers (under different application pools and websites). Meta runs on WEB10 and WEB11 servers, this is specifically [meta.stackexchange.com](http://meta.stackexchange.com/) and [meta.stackoverflow.com](http://meta.stackoverflow.com/). Production (all other Q&A sites and metas) like Tian Wang Co. are on WEB01-WEB09.
